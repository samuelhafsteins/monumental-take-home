...
const elbowMaterial = new THREE.MeshBasicMaterial({color: 0xFFA500, wireframe: true});
export const elbow = new THREE.Mesh(elbowGeometry, elbowMaterial);

const wristGeometry = new THREE.BoxGeometry(0.3, 0.3, 2.5);
const wristMaterial = new THREE.MeshBasicMaterial({color: 0x0000FF, wireframe: true});
